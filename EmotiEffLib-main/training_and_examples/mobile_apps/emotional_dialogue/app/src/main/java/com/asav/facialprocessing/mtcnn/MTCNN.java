...
public class MTCNN {
    ...
    public MTCNN(Context context) throws IOException {
        ...
        Log.i("MTCNN","timecost number of cores:"+numCores);
        numCores=4;
        pInterpreter = new Interpreter(FileUtil.loadMappedFile(context, MODEL_FILE_PNET),
                new Interpreter.Options().setNumThreads(numCores));
        rInterpreter = new Interpreter(FileUtil.loadMappedFile(context, MODEL_FILE_RNET),
                new Interpreter.Options().setNumThreads(numCores));
        oInterpreter = new Interpreter(FileUtil.loadMappedFile(context, MODEL_FILE_ONET),
                new Interpreter.Options().setNumThreads(numCores));
    }
